...
Heatmap(matrix(adjacency, dim(adjacency), dimnames = list(rownames(adjacency), colnames(adjacency))),
        name='Network Arcs', column_title="To", column_title_side="top", row_title="From", row_title_side="left",
  ...
  rowAnnotation("Number of Children" = anno_barplot(apply(adjacency,1,sum), width = unit(4, "cm")))
}

plot.adjacency.matrix(adjacency, "adjacencyTest.png")
